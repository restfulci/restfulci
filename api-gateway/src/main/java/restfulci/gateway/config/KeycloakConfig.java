package restfulci.gateway.config;
...
import restfulci.gateway.config.source.KeycloakSource;
...
public class KeycloakConfig {
	...
	/*
	 * To test locally in STS, it is important to add
	 * `SPRING_PROFILES_ACTIVE=dev` in run configuration.
	 */
	@Profile("dev")
	@Bean
