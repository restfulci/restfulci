...
public class DatabaseConfig {
	...
	public DataSource devDataSource() {
		...
		dataSource.setUrl("jdbc:postgresql://localhost:5433/restfulci-job");
	...
	public DataSource dockerDataSource() {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("org.postgresql.Driver");
		dataSource.setUrl("jdbc:postgresql://job-postgres:5432/restfulci-job");
	...
	public DataSource kubernetesDataSource() {
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("org.postgresql.Driver");
		dataSource.setUrl("jdbc:postgresql://restfulci-job-postgres:5432/restfulci-job");
		dataSource.setUsername(postgresUser);
		dataSource.setPassword(postgresPassword);
		return dataSource;
	}
